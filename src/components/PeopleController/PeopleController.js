(function() {
  ...
  function _attachEventListener(self) {
    ...
    self.shadowRoot.addEventListener("PersonClicked", e => {
      //e contains the id of the person that was clicked
      //we'll find them using this id in the self.people list
